...
This project is in early planning stages ([README.md](README.md) / [CLAUDE.md](CLAUDE.md)) and has no released versions yet. Once releases begin, supported versions will be listed here.
